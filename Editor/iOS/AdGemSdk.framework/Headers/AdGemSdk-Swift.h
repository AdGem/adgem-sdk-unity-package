...
#ifndef ADGEMSDK_SWIFT_H
#define ADGEMSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AdGemSdk",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)
@class NSString;
@protocol AdGemDelegate;
@class AdGemPlayerMetadata;

SWIFT_CLASS("_TtC8AdGemSdk5AdGem")
@interface AdGem : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull sdkVersion;)
+ (NSString * _Nonnull)sdkVersion SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull prodBaseURL;)
+ (NSString * _Nonnull)prodBaseURL SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_PROTOCOL("_TtP8AdGemSdk13AdGemDelegate_")
@protocol AdGemDelegate
...
typedef SWIFT_ENUM(NSInteger, AdGemGender, open) {
  AdGemGenderMale = 0,
  AdGemGenderFemale = 1,
  AdGemGenderUnknown = 2,
};


SWIFT_CLASS("_TtC8AdGemSdk19AdGemPlayerMetadata")
@interface AdGemPlayerMetadata : NSObject
@property (nonatomic, readonly, copy) NSDictionary<NSString *, NSString *> * _Nonnull entries;
...
- (Builder * _Nonnull)playerPlacementWithPlace:(NSInteger)place SWIFT_WARN_UNUSED_RESULT;
- (Builder * _Nonnull)playerCreatedAtCreationDate:(NSDate * _Nonnull)creationDate SWIFT_WARN_UNUSED_RESULT;
- (Builder * _Nonnull)playerPayerWithSpentMoney:(BOOL)spentMoney SWIFT_WARN_UNUSED_RESULT;
- (Builder * _Nonnull)playerIAPTotalWithIapTotal:(double)iapTotal SWIFT_WARN_UNUSED_RESULT;
- (Builder * _Nonnull)customField1WithField:(NSString * _Nonnull)field SWIFT_WARN_UNUSED_RESULT;
- (Builder * _Nonnull)customField2WithField:(NSString * _Nonnull)field SWIFT_WARN_UNUSED_RESULT;
- (Builder * _Nonnull)customField3WithField:(NSString * _Nonnull)field SWIFT_WARN_UNUSED_RESULT;
